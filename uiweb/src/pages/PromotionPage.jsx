...
const MOCK_DRAGON_BOAT = {
  ...
  title: '端午安康',
  subtitle: '江上的风吹来了，顺便带来了折扣 · 最高 9.2 折 — 来自 Claude',
  emoji: '🐉',
  theme_color: 'green',
  ...
  skus: [
    ...
    },
    {
      ...
      emoji: '🥩', price_yuan: 55, delivered_yuan: 60, price_display: '',
      total_limit: 0, per_user_limit: 1, sold_count: 0,
      highlight: false, state: 'purchasable', user_can_buy_n: 1, user_bought_n: 0,
    },
    {
      id: 'preview-db-4', sku_key: 'preview-db-4', label: '龙舟令', subtitle: '主推 · 9.2 折',
      emoji: '🐉', price_yuan: 88, delivered_yuan: 96, price_display: '',
      total_limit: 0, per_user_limit: 1, sold_count: 0,
      highlight: true, state: 'purchasable', user_can_buy_n: 1, user_bought_n: 0,
    },
    {
      id: 'preview-db-5', sku_key: 'preview-db-5', label: '屈原赋', subtitle: '',
      emoji: '📜', price_yuan: 188, delivered_yuan: 205, price_display: '',
      total_limit: 0, per_user_limit: 1, sold_count: 0,
      highlight: false, state: 'purchasable', user_can_buy_n: 1, user_bought_n: 0,
    },
    {
      id: 'preview-db-6', sku_key: 'preview-db-6', label: '百年粽', subtitle: '',
      emoji: '🍱', price_yuan: 288, delivered_yuan: 313, price_display: '',
      total_limit: 0, per_user_limit: 1, sold_count: 0,
      highlight: false, state: 'purchasable', user_can_buy_n: 1, user_bought_n: 0,
    },
  ],
