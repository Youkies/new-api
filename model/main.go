...
func migrateDBFast() error {
	...
	migrations := []struct {
		...
		{&UINotificationRead{}, "UINotificationRead"},
		...
		{&UIPlaygroundFood{}, "UIPlaygroundFood"},
...
func migrateLOGDB() error {
	var err error
	if err = LOG_DB.AutoMigrate(&Log{}, &DebugKeyTrace{}); err != nil {
		return err
	}
	return nil
}
