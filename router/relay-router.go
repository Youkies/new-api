...
func SetRelayRouter(router *gin.Engine) {
	...
	debugConnectivityRouter := router.Group("/v1/debug/connectivity")
	debugConnectivityRouter.Use(middleware.RouteTag("relay"))
	debugConnectivityRouter.Use(middleware.TokenAuth())
	{
		debugConnectivityRouter.GET("", controller.DebugKeyConnectivity)
		debugConnectivityRouter.POST("", controller.DebugKeyConnectivity)
	}
	...
	modelsRouter.Use(controller.DebugKeyConnectivityProbe())
	{
	...
	geminiRouter.Use(controller.DebugKeyConnectivityProbe())
	{
	...
	geminiCompatibleRouter.Use(controller.DebugKeyConnectivityProbe())
	{
	...
	relayV1Router.Use(controller.DebugKeyConnectivityProbe())
	...
	relaySunoRouter.Use(middleware.TokenAuth(), controller.DebugKeyConnectivityProbe(), middleware.Distribute())
	{
	...
	relayGeminiRouter.Use(controller.DebugKeyConnectivityProbe())
...
func registerMjRouterGroup(relayMjRouter *gin.RouterGroup) {
	...
	relayMjRouter.Use(middleware.TokenAuth(), controller.DebugKeyConnectivityProbe(), middleware.Distribute())
	{
