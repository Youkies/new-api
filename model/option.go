...
func InitOptionMap() {
	...
	common.OptionMap["UserUsableGroupDetails"] = setting.UserUsableGroupDetails2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "UserUsableGroupDetails":
		err = setting.UpdateUserUsableGroupDetailsByJSONString(value)
