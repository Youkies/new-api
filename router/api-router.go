...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		uiRoute := apiRouter.Group("/ui")
		{
			...
			uiRoute.GET("/model-reviews/rankings", middleware.TryUserAuth(), controller.GetUIModelReviewRankings)
			uiRoute.GET("/model-reviews", middleware.TryUserAuth(), controller.ListUIModelReviews)
			uiRoute.GET("/model-reviews/eligibility", middleware.UserAuth(), controller.GetUIModelReviewEligibility)
			uiRoute.POST("/model-reviews", middleware.UserAuth(), middleware.CriticalRateLimit(), controller.UpsertUIModelReview)
			uiRoute.GET("/model-reviews/points", middleware.UserAuth(), controller.GetUIModelReviewPointAccount)
			uiRoute.POST("/model-reviews/points/redeem", middleware.UserAuth(), middleware.CriticalRateLimit(), controller.RedeemUIModelReviewPoints)
			uiRoute.POST("/model-reviews/:id/helpful", middleware.UserAuth(), middleware.CriticalRateLimit(), controller.MarkUIModelReviewHelpful)
			...
			uiAdminRoute.Use(middleware.AdminAuth())
			{
				...
				uiAdminRoute.GET("/model-reviews/settings", controller.AdminGetUIModelReviewSetting)
				uiAdminRoute.PUT("/model-reviews/settings", controller.AdminSaveUIModelReviewSetting)
				uiAdminRoute.GET("/model-reviews", controller.AdminListUIModelReviews)
				uiAdminRoute.PATCH("/model-reviews/:id", controller.AdminPatchUIModelReview)
