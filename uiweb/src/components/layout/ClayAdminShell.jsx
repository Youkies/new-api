...
import { Bell, Bot, Bug, Gamepad2, Home, LayoutDashboard, LogOut, Megaphone, Menu, Settings2, ShieldCheck, Wallet } from 'lucide-react'
...
const NAV = [
  ...
  { to: '/admin/kpay-topups', label: '充值', icon: Wallet },
