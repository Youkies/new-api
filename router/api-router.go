...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		uiRoute := apiRouter.Group("/ui")
		{
			...
			uiRoute.GET("/playground/foods", middleware.UserAuth(), controller.ListUIPlaygroundFoods)
			uiRoute.GET("/playground/foods/:id/image", middleware.TryUserAuth(), controller.GetUIPlaygroundFoodImage)
			...
			uiRoute.GET("/playground/sessions", middleware.UserAuth(), controller.ListUIPlaygroundSessions)
			uiRoute.POST("/playground/sessions", middleware.UserAuth(), middleware.CriticalRateLimit(), controller.CreateUIPlaygroundSession)
			uiRoute.PUT("/playground/sessions/:id", middleware.UserAuth(), controller.UpdateUIPlaygroundSession)
			uiRoute.DELETE("/playground/sessions/:id", middleware.UserAuth(), controller.DeleteUIPlaygroundSession)
			uiRoute.GET("/playground/sessions/:id/messages", middleware.UserAuth(), controller.ListUIPlaygroundMessages)
			uiRoute.POST("/playground/sessions/:id/messages", middleware.UserAuth(), controller.CreateUIPlaygroundMessage)
			uiRoute.DELETE("/playground/sessions/:id/messages", middleware.UserAuth(), controller.ClearUIPlaygroundMessages)
			uiRoute.DELETE("/playground/messages/:id", middleware.UserAuth(), controller.DeleteUIPlaygroundMessage)
			uiRoute.GET("/playground/images", middleware.UserAuth(), controller.ListUIPlaygroundImages)
			uiRoute.POST("/playground/images", middleware.UserAuth(), middleware.CriticalRateLimit(), controller.CreateUIPlaygroundImage)
			uiRoute.GET("/playground/images/:id/image", middleware.UserAuth(), controller.GetUIPlaygroundImage)
			uiRoute.DELETE("/playground/images/:id", middleware.UserAuth(), controller.DeleteUIPlaygroundImage)
			...
			uiRoute.POST("/notifications/read-all", middleware.UserAuth(), controller.ReadAllUINotifications)
			uiRoute.POST("/notifications/:id/read", middleware.UserAuth(), controller.ReadUINotification)
			uiRoute.POST("/notifications/:id/ack", middleware.UserAuth(), controller.AckUINotification)
			...
			uiRoute.DELETE("/assistant/conversations/:id", middleware.UserAuth(), controller.DeleteUIAssistantConversation)
			uiRoute.POST("/assistant/analyze", middleware.UserAuth(), middleware.CriticalRateLimit(), controller.AnalyzeUIAssistant)
			uiRoute.POST("/assistant/chat", middleware.UserAuth(), middleware.CriticalRateLimit(), controller.ChatUIAssistant)
			...
			uiAdminRoute.Use(middleware.AdminAuth())
			{
				...
				uiAdminRoute.DELETE("/notifications/:id", controller.AdminDeleteUINotification)
				...
				uiAdminRoute.POST("/refund-appeals/approve-all", controller.AdminApproveAllUIRefundAppeals)
				...
				uiAdminRoute.GET("/playground-foods", controller.AdminListUIPlaygroundFoods)
				uiAdminRoute.GET("/playground-foods/:id", controller.AdminGetUIPlaygroundFood)
				uiAdminRoute.PUT("/playground-foods/:id", controller.AdminUpdateUIPlaygroundFood)
				uiAdminRoute.POST("/playground-foods/:id/approve", controller.AdminApproveUIPlaygroundFood)
		...
		apiRouter.POST("/kpay/notify", controller.KPayNotify)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.POST("/promotion/:slug/order", middleware.CriticalRateLimit(), controller.OrderPromotionSku)
