...
type ChannelSettings struct {
	...
	SystemPromptToUserPrompt bool   `json:"system_prompt_to_user_prompt,omitempty"`
}
...
type ChannelOtherSettings struct {
	...
	ClaudeAssistantPrefillCompat          bool          `json:"claude_assistant_prefill_compat,omitempty"` // 是否兼容不支持 assistant prefill 的 Claude 上游
